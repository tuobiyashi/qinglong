...
update_qinglong() {
    ...
    reset_romote_url ${dir_root} "${github_proxy_url}https://github.com/tuobiyashi/qinglong.git"
    ...
    local url="${github_proxy_url}https://github.com/tuobiyashi/qinglong-static.git"
